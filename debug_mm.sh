...
CUDA_VISIBLE_DEVICES=7 AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0 python -m debugpy --listen 0.0.0.0:18888 --wait-for-client finetune_sdm_yaml.py   \
    ...
    --log_dir runtest/exp/s3_temmotion_stsa_loadnomm_debug \
    --epochs 20 --deepspeed \
