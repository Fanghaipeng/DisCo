...
python tool/merge_subfolder.py -i ${pred_folder} -o ${pred_folder}_frames --frame_idx -1
python tool/merge_subfolder.py -i ${gt_folder} -o ${gt_folder}_frames --frame_idx -1
...
# # FVD eval
python tool/metrics/metric_center.py --root_dir /data/fanghaipeng/project/DYL/DisCo/runtest --path_gen ${pred_folder}_16framemp4 --path_gt ${gt_folder}_16framemp4 --type fid-vid fvd dtssd --write_metric_to ${exp_folder}/metrics_fid-vid_fvd_dtssd_16frames.json --number_sample_frames 16 --sample_duration 16
