...
export AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0  CUDA_VISIBLE_DEVICES=4,5
echo $CUDA_VISIBLE_DEVICES

mpirun -np 2 python finetune_sdm_yaml.py   \
    ...
    --log_dir runtest/exp/s3_tem_t_samenoise_debug \
    --epochs 20 --deepspeed \
