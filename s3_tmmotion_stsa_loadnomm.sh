...
export AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0  CUDA_VISIBLE_DEVICES=3,4,5,6
...
mpirun -np 4 python finetune_sdm_yaml.py   \
    ...
    --log_dir runtest/exp/s3_temmotion_stsa_loadnomm_3 \
    --epochs 36 --deepspeed \
    ...
    --drop_ref 0.05  \
    --guidance_scale 1.5 \
    --pretrained_model /data/fanghaipeng/project/DYL/DisCo/runtest/exp/s3_temmotion_stsa_loadnomm_2/15999.pth/mp_rank_00_model_states.pt \
