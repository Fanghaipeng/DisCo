...
# python  tool/metrics/metric_center.py --root_dir /data/fanghaipeng/project/DYL/DisCo/runtest --path_gen ${pred_folder}/ --path_gt ${gt_folder} --type l1 ssim lpips psnr  clean-fid --write_metric_to ${exp_folder}/metrics_l1_ssim_lpips_psnr.json
...
# CUDA_VISIBLE_DEVICES=4 AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0 python -m debugpy --listen 0.0.0.0:4567 --wait-for-client python  tool/metrics/metric_center.py --root_dir /data/fanghaipeng/project/DYL/DisCo/runtest --path_gen ${pred_folder}/ --path_gt ${gt_folder}/ --type fid-vid fvd  --write_metric_to ${exp_folder}/metrics_fid-vid_fvd.json --number_sample_frames 16 --sample_duration 16
CUDA_VISIBLE_DEVICES=4 AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0 python -m debugpy --listen 0.0.0.0:4567 --wait-for-client python  tool/metrics/metric_center.py --root_dir /data/fanghaipeng/project/DYL/DisCo/runtest --path_gen ${pred_folder}/ --path_gt ${gt_folder}/ --type fid-vid fvd  --write_metric_to ${exp_folder}/metrics_fid-vid_fvd.json --number_sample_frames 16 --sample_duration 16
