...
export AZFUSE_USE_FUSE=0 NCCL_ASYNC_ERROR_HANDLING=0  CUDA_VISIBLE_DEVICES=1,2,3,4
export MASTER_PORT=16666
...
mpirun -np 4 python finetune_sdm_yaml.py   \
    ...
    --log_dir runtest/exp/s3_tem_t_motion_nosame_nomotion \
    --epochs 20 --deepspeed \
    ...
    --drop_ref 0.05  \
    --guidance_scale 1.5 \
    --pretrained_model /data/fanghaipeng/project/DYL/Resources/checkpoints/tiktokmore_cfg.pt \
